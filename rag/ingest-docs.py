...
def main():
  parser = argparse.ArgumentParser(
      description="Ingest handbook docs into Vertex AI Search"
  )
  ...
  parser.add_argument(
      "--gcs-uri", help="e.g. gs://<project>-hr-policies-source/*"
  )
  ...
  if operation.exception():
    ...
    sys.exit(1)
  print(
      "[DONE] Import finished. Verify with: uv run python"
      " rag/verify-rag-search.py --query '...'"
  )
